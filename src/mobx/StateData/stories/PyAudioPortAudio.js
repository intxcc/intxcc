...
const StoryData = {
  ...
  summary: 'The most popular repository of mine (currently 49 stars and 13 forks on GitHub) and the only python module (that I know of, but I\'ve searched quite a bit before starting the development) able to record an output audio stream on windows. This is the only one, because that was initially the reason I developed this and I was quite astonished, that there was not already a solution to this problem.'
}
