...
const StoryText = (
  <p>
    ...
    <br />
    The platform written from scratch was primary a polling platform. I tried to develop a method to make the polls cryptographically replicable, using hashes everybody could (theoretically) verify, nowadays I would probably use a blockchain approach for this use case.<br />
    <br />
